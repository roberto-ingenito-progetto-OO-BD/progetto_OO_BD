...
\lstinputlisting[firstline=2]{../basi_di_dati/triggers/works_at_no_duplicates.sql}
...
\lstinputlisting[firstline=2, lastline=64]{../basi_di_dati/functions/check_seniority.sql}\bigskip
